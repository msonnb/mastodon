...
ActiveRecord::Schema[8.0].define(version: 2025_06_21_115434) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "bluesky_cross_posting_enabled", default: false, null: false
    t.string "bluesky_handle"
    t.string "bluesky_did"
    t.string "encrypted_bluesky_password"
